...
/* PetraeFichierPlanteBundle:Plante:index.html.twig */
class __TwigTemplate_d3acd48ecfc139752da10620f080bd03 extends Twig_Template
{
    ...
    <ul>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["plante"]) {
            ...
            echo "            <li>
                <a href=\"";
            // line 14
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("plante_show", array("id" => $this->getAttribute((isset($context["plante"]) ? $context["plante"] : $this->getContext($context, "plante")), "id"))), "html", null, true);
            echo "\">";
...
";
    ...
    {
        return "PetraeFichierPlanteBundle:Plante:index.html.twig";
    }
